...
export const pageQuery = graphql`query ($listType: String!, $slug: String!, $skip: Int!, $limit: Int!, $tagID: String!) {
  ...
  posts: allMarkdownRemark(
    ...
    filter: {frontmatter: {type: {eq: $listType}, tags: {eq: $tagID}}, published: {eq: true}}
    limit: $limit
    skip: $skip
  ) {
    edges {
